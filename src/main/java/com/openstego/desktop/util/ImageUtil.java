...
public class ImageUtil {
     ...
     */
    public static ImageHolder generateRandomImage(int numOfPixels) throws DIRPException {
     ...
     * @throws DIRPException Processing issues
     */
    public static byte[] imageToByteArray(ImageHolder image, String imageFileName, DIRPPlugin<?> plugin) throws DIRPException {
        ...
        if (imageFileName != null) {
            ...
            if (!plugin.getWritableFileExtensions().contains(imageType)) {
                throw new DIRPException(null, DIRP.NAMESPACE, DIRPErrors.IMAGE_TYPE_INVALID, imageType);
            }
     ...
     * @throws DIRPException Processing issues
     */
    public static ImageHolder byteArrayToImage(byte[] imageData, String imgFileName) throws DIRPException {
        if (imageData == null) {
            return null;
        }
        ...
        if (image == null) {
            throw new DIRPException(null, DIRP.NAMESPACE, DIRPErrors.IMAGE_FILE_INVALID, imgFileName);
        }
        return image;
    }
     ...
     * @throws DIRPException Processing issues
     */
    public static ImageHolder getDiffImage(ImageHolder leftImage, ImageHolder rightImage) throws DIRPException {
        int leftW;
        int leftH;
        int rightW;
        int rightH;
        ...
        if (leftW != rightW || leftH != rightH) {
            throw new DIRPException(null, DIRP.NAMESPACE, DIRPErrors.IMAGE_FILE_INVALID);
        }
    ...
    private static void writeImage(ImageHolder image, String imageType, OutputStream os) throws DIRPException {
    ...
    private static void writeJpegImage(ImageHolder image, OutputStream os) throws DIRPException {
        try {
    ...
    private static ImageHolder readImage(InputStream is) throws DIRPException {
        try {
