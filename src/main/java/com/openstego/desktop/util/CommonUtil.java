...
public class CommonUtil {
     ...
     */
    public static byte[] streamToBytes(InputStream is) throws DIRPException {
     ...
     * @throws DIRPException Processing issues
     */
    public static byte[] fileToBytes(File file) throws DIRPException {
     ...
     * @throws DIRPException Processing issues
     */
    public static void writeFile(byte[] fileData, String fileName) throws DIRPException {
        File file = null;
     ...
     * @throws DIRPException Processing issues
     */
    public static void writeFile(byte[] fileData, File file) throws DIRPException {
