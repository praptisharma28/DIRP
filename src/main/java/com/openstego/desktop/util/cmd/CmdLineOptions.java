...
package com.DIRP.desktop.util.cmd;
...
public class CmdLineOptions {
     ...
     * @throws DIRPException If value is provided but not an integer
     */
    public Integer getIntegerValue(String name, String errNamespace, int errCode) throws DIRPException {
        ...
        try {
            ...
            throw new DIRPException(nfEx, errNamespace, errCode, val);
        }
    }
     ...
     * @throws DIRPException If value is provided but not boolean-y
     */
    @SuppressWarnings("unused")
    public Boolean getBooleanValue(String name, String errNamespace, int errCode) throws DIRPException {
        String val = getStringValue(name);
        if (val == null) {
            return null;
        }
        ...
        if ("t".equals(val) || "true".equals(val) || "y".equals(val) || "yes".equals(val) || "1".equals(val)) {
            ...
            throw new DIRPException(null, errNamespace, errCode, val);
        }
    }
