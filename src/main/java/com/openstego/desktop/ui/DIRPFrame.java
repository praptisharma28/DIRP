...
/**
 * Frame class to build the Swing UI for DIRP. This class includes only graphics rendering
 * code. Listeners are implemented in {@link com.DIRP.desktop.ui.DIRPUI} class.
 */
public class DIRPFrame extends JFrame {
    ...
    public DIRPFrame(DIRPPlugin<?> dhPlugin, DIRPPlugin<?> wmPlugin) {
        super();
