...
/**
 * Abstract class for stego plugins for DIRP purpose of which is watermarking. It implements few methods which are
 ...
 */
public abstract class WatermarkingPlugin<C extends DIRPConfig> extends DIRPPlugin<C> {
    // ------------- Metadata Methods -------------
