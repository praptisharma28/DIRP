...
/**
 * Abstract class for stego plugins for DIRP purpose of which is data hiding. It implements few methods which are
 ...
 */
public abstract class DataHidingPlugin<C extends DIRPConfig> extends DIRPPlugin<C> {
    // ------------- Metadata Methods -------------
