...
/**
 * Custom exception class for DIRP
 */
public class DIRPException extends Exception {
     ...
     */
    public DIRPException(Throwable cause) {
        this(cause, DIRP.NAMESPACE, UNHANDLED_EXCEPTION, (Object[]) null);
    }
     ...
     */
    public DIRPException(Throwable cause, String namespace, int errorCode) {
     ...
     */
    public DIRPException(Throwable cause, String namespace, int errorCode, String param) {
     ...
     */
    public DIRPException(Throwable cause, String namespace, int errorCode, Object... params) {
        super((DIRP.NAMESPACE.equals(namespace) && errorCode == UNHANDLED_EXCEPTION) ? cause.toString()
