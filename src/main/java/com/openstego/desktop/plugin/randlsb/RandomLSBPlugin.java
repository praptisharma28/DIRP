...
import com.DIRP.desktop.plugin.lsb.*;
...
/**
 * Plugin for DIRP which implements the Random LSB algorithm of steganography
 */
    ...
    public byte[] extractData(byte[] stegoData, String stegoFileName, byte[] origSigData) throws DIRPException {
        ...
        try (RandomLSBInputStream lsbIS = new RandomLSBInputStream(imgHolder, this.config)) {
            ...
            if (bytesRead != data.length) {
                throw new DIRPException(null, LSBPlugin.NAMESPACE, LSBErrors.ERR_IMAGE_DATA_READ);
            }
