...
public class LSBOutputStream extends OutputStream {
     ...
     */
    public LSBOutputStream(ImageHolder image, int dataLength, String fileName, DIRPConfig config) throws DIRPException {
     ...
     * @throws DIRPException Processing issues
     */
    public ImageHolder getImage() throws DIRPException {
        try {
            flush();
