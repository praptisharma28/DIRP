...
public class LSBEmbedOptionsUI extends PluginEmbedOptionsUI {
    ...
    /**
     * Reference to the parent DIRPUI object
     */
    private final DIRPFrame stegoUI;
     ...
     */
    public LSBEmbedOptionsUI(DIRPFrame stegoUI) {
     ...
     */
    @Override
    public void setGUIFromConfig(DIRPConfig config) {
     ...
     */
    @Override
    public void setConfigFromGUI(DIRPConfig config) {
