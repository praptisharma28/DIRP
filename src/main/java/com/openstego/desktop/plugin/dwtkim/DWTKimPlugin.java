...
/**
 * Plugin for DIRP which implements the DWT based algorithm by Kim.
 * <p>
...
public class DWTKimPlugin extends WMImagePluginTemplate {
    ...
    public byte[] embedData(byte[] msg, String msgFileName, byte[] cover, String coverFileName, String stegoFileName) throws DIRPException {
        ...
        if (cover == null) {
            throw new DIRPException(null, NAMESPACE, DWTKimErrors.ERR_NO_COVER_FILE);
        } else {
        ...
        if (sig.decompositionLevel > levels) {
            throw new DIRPException(null, NAMESPACE, DWTKimErrors.ERR_DECOMP_LEVEL_NOT_ENOUGH);
        }
        ...
        while (p.getCoarse() != null) {
            if (p.getHorizontal() == null || p.getVertical() == null || p.getDiagonal() == null) {
                throw new DIRPException(null, NAMESPACE, DWTKimErrors.ERR_FILE_TOO_SMALL);
            }
        ...
        public Signature(byte[] sigData) throws DIRPException {
            ...
            try {
                ...
                if (n == -1 || !(new String(this.sig)).equals(new String(inputSig))) {
                    throw new DIRPException(null, NAMESPACE, DWTKimErrors.ERR_SIG_NOT_VALID);
                }
