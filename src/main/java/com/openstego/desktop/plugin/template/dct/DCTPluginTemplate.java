...
/**
 * Template plugin for DIRP which implements the DCT based steganography for images (transfer domain)
 */
public abstract class DCTPluginTemplate extends DIRPPlugin<DCTConfig> {
    /**
