...
import com.DIRP.desktop.util.dwt.DWTUtil;
...
/**
 * Plugin for DIRP which implements the DWT based algorithm by Xie.
 * <p>
...
public class DWTXiePlugin extends WMImagePluginTemplate {
    ...
    public byte[] embedData(byte[] msg, String msgFileName, byte[] cover, String coverFileName, String stegoFileName) throws DIRPException {
        ...
        if (cover == null) {
            throw new DIRPException(null, NAMESPACE, DWTXieErrors.ERR_NO_COVER_FILE);
        } else {
        ...
        public Signature(byte[] sigData) throws DIRPException {
            ...
            try {
                ...
                if (n == -1 || !(new String(this.sig)).equals(new String(inputSig))) {
                    throw new DIRPException(null, NAMESPACE, DWTXieErrors.ERR_SIG_NOT_VALID);
                }
